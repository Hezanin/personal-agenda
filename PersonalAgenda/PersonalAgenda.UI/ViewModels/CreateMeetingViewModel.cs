...
{
    class CreateMeetingViewModel : Screen
    {
        ...
        private string companyNameTextBox;
        ...
        {
			get { return companyNameTextBox; }
			set { companyNameTextBox = value;
                NotifyOfPropertyChange(() => CompanyNameTextBox);
            }
		}
            ...
            string cityTextBox, string dateTimeTextBox, string companyNameTextBox)
		{
            ...
            return !String.IsNullOrWhiteSpace(nameTextBox) && !String.IsNullOrWhiteSpace(descriptionTextBox) &&
				...
				!String.IsNullOrWhiteSpace(dateTimeTextBox) && !String.IsNullOrWhiteSpace(companyNameTextBox) &&
                Regex.IsMatch(dateTimeTextBox, pattern);
		}
		...
		{         
            try
			{
                this.meetingsFileAccess.AddMeeting(new Domain.Entities.Meeting()
                {
                    Name = NameTextBox,
                    ...
                    City = CityTextBox,
                    CompanyName = CompanyNameTextBox,
                });
            }
			catch (Exception ex)
			{
